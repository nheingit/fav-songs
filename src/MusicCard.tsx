      ...
      try {
         const response = await fetch('https://api.edenai.run/v2/image/generation', {
          ...
          headers: {
            ...
            'Authorization': 'Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VyX2lkIjoiY2M0MGIxMmItYWZkYi00NDIyLWJmMDAtNmM5MGY1MjhlYWU2IiwidHlwZSI6ImFwaV90b2tlbiJ9.pyTv8PpJifJ68H98k7w9HwbnOwJ34o2vq19YpDXvsgc',
        ...
        const imageResourceUrl = data?.stabilityai?.items[0]?.image_resource_url
            if(imageResourceUrl && imageUrl === null) {
